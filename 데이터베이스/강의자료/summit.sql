...
INSERT INTO s_customer VALUES (
   ...
   '72 Via Bahia', 'Sao Paolo', NULL, 'Brazil', NULL,'EXCELLENT', 12, 2, NULL);
INSERT INTO s_customer VALUES (
   202, 'OJ Atheletics', '81-20101',
   '6741 Takashi Blvd.', 'Osaka', NULL, 'Japan', NULL,'POOR', 14, 4, NULL);
INSERT INTO s_customer VALUES (
   203, 'Delhi Sports', '91-10351',
   '11368 Chanakya', 'New Delhi', NULL, 'India', NULL,'GOOD', 14, 4, NULL);
INSERT INTO s_customer VALUES (
...
INSERT INTO s_emp VALUES (
  1, 'Velasquez', 'Carmen', 'cvelasqu',to_date('03/03/2012', 'dd/mm/yyyy'), NULL, NULL, 'President',50, 2500, NULL);
INSERT INTO s_emp VALUES (
   2, 'Ngao', 'LaDoris', 'lngao',to_date('08/03/2012', 'dd/mm/yyyy'), NULL, 1, 'VP, Operations', 41, 1450, NULL);
INSERT INTO s_emp VALUES (
   3, 'Nagayama', 'Midori', 'mnagayam',   to_date('17/02/2013', 'dd/mm/yyyy'), NULL, 1, 'VP, Sales',   31, 1400, NULL);
INSERT INTO s_emp VALUES (
   4, 'Quick-To-See', 'Mark', 'mquickto',   to_date('07/04/2012', 'dd/mm/yyyy'), NULL, 1, 'VP, Finance',   10, 1450, NULL);
INSERT INTO s_emp VALUES (
   5, 'Ropeburn', 'Audry', 'aropebur', to_date('04/03/2012', 'dd/mm/yyyy') , NULL, 1, 'VP, Administration',
   50, 1550, NULL);
INSERT INTO s_emp VALUES (
   6, 'Urguhart', 'Molly', 'murguhar', to_date('18/01/2013', 'dd/mm/yyyy'), NULL, 2, 'Warehouse Manager', 41, 1200, NULL);
INSERT INTO s_emp VALUES (
   7, 'Menchu', 'Roberta', 'rmenchu', to_date('14/05/2012', 'dd/mm/yyyy') , NULL, 2, 'Warehouse Manager', 42, 1250, NULL);
INSERT INTO s_emp VALUES (
   8, 'Biri', 'Ben', 'bbiri', to_date('07/04/212', 'dd/mm/yyyy'), NULL, 2, 'Warehouse Manager', 43, 1100, NULL);
INSERT INTO s_emp VALUES (
   9, 'Catchpole', 'Antoinette', 'acatchpo',  to_date('09/02/2013', 'dd/mm/yyyy'), NULL, 2, 'Warehouse Manager', 44, 1300, NULL);
INSERT INTO s_emp VALUES (
   10, 'Havel', 'Marta', 'mhavel', to_date('27/02/2013', 'dd/mm/yyyy') , NULL, 2, 'Warehouse Manager', 45, 1307, NULL);
INSERT INTO s_emp VALUES (
   11, 'Magee', 'Colin', 'cmagee', to_date('14/05/2012', 'dd/mm/yyyy') , NULL, 3, 'Sales Representative', 31, 1400, 10);
INSERT INTO s_emp VALUES (
   12, 'Giljum', 'Henry', 'hgiljum', to_date('18/01/2013', 'dd/mm/yyyy') , NULL, 3, 'Sales Representative',  32, 1490, 12.5);
INSERT INTO s_emp VALUES (
   13, 'Sedeghi', 'Yasmin', 'ysedeghi', to_date('18/02/2013', 'dd/mm/yyyy'), NULL, 3, 'Sales Representative',  33, 1515, 10);
INSERT INTO s_emp VALUES (
   14, 'Nguyen', 'Mai', 'mnguyen', to_date('22/01/2012', 'dd/mm/yyyy'), NULL, 3, 'Sales Representative', 34, 1525, 15);
INSERT INTO s_emp VALUES (
   15, 'Dumas', 'Andre', 'adumas', to_date('09/10/2012','dd/mm/yyyy'),  NULL, 3, 'Sales Representative', 35, 1450, 17.5);
INSERT INTO s_emp VALUES (
   16, 'Maduro', 'Elena', 'emaduro', to_date('07/02/2012','dd/mm/yyyy'),  NULL, 6, 'Stock Clerk',  41, 1400, NULL);
INSERT INTO s_emp VALUES (
   17, 'Smith', 'George', 'gsmith',to_date('08/03/2011', 'dd/mm/yyyy'), NULL, 6, 'Stock Clerk',  41, 940, NULL);
INSERT INTO s_emp VALUES (
   18, 'Nozaki', 'Akira', 'anozaki',to_date('09/02/2012', 'dd/mm/yyyy'),NULL, 7, 'Stock Clerk',  42, 1200, NULL);
INSERT INTO s_emp VALUES (
   19, 'Patel', 'Vikram', 'vpatel',to_date('06/08/2011', 'dd/mm/yyyy'), NULL, 7, 'Stock Clerk',  42, 795, NULL);
INSERT INTO s_emp VALUES (
   20, 'Newman', 'Chad', 'cnewman',to_date('21/07/2010', 'dd/mm/yyyy'), NULL, 8, 'Stock Clerk',  43, 750, NULL);
INSERT INTO s_emp VALUES (
   21, 'Markarian', 'Alexander', 'amarkari',to_date('26/05/2011', 'dd/mm/yyyy'), NULL, 8, 'Stock Clerk', 43, 850, NULL);
INSERT INTO s_emp VALUES (
   22, 'Chang', 'Eddie', 'echang',to_date('30/11/2012', 'dd/mm/yyyy'), NULL, 9, 'Stock Clerk', 44, 800, NULL);
INSERT INTO s_emp VALUES (
   23, 'Patel', 'Radha', 'rpatel',to_date('17/10/2011', 'dd/mm/yyyy'), NULL, 9, 'Stock Clerk', 34, 795, NULL);
INSERT INTO s_emp VALUES (
   24, 'Dancs', 'Bela', 'bdancs',to_date('17/03/2011', 'dd/mm/yyyy'), NULL, 10, 'Stock Clerk', 45, 860, NULL);
INSERT INTO s_emp VALUES (
   25, 'Schwartz', 'Sylvie', 'sschwart',to_date('09/05/2012', 'dd/mm/yyyy'), NULL, 10, 'Stock Clerk',  45, 1100, NULL);
COMMIT;
...
INSERT INTO s_inventory VALUES (
   40422, 101, 0, 350, 600, 'Phenomenal sales', to_date('08/02/2013', 'dd/mm/yyyy'));
INSERT INTO s_inventory VALUES (
...
INSERT INTO s_inventory VALUES (
   50532, 101, 0, 100, 175, 'Wait for Spring.', to_date('12/03/2012','dd/mm/yyyy'));
INSERT INTO s_inventory VALUES (
...
INSERT INTO s_inventory VALUES (
   ...
   'early February.', to_date('07/09/2012','dd/mm/yyyy'));
INSERT INTO s_inventory VALUES (
...
INSERT INTO s_ord VALUES (
   100, 204, to_date('31/08/2012','dd/mm/yyyy'),to_date('10/09/2012','dd/mm/yyyy'), 
   11, 601100, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   101, 205, to_date('31/08/2012','dd/mm/yyyy'),to_date('15/09/2012','dd/mm/yyyy'),
   14, 8056.6, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   102, 206, to_date('01/09/2012', 'dd/mm/yyyy'),to_date('08/09/2012','dd/mm/yyyy'),
   15, 8335, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   103, 208, to_date('02/09/2012', 'dd/mm/yyyy'),to_date('22/09/2012','dd/mm/yyyy'),
   15, 377, 'CASH', 'Y');
INSERT INTO s_ord VALUES (
   104, 208, to_date('03/09/2012', 'dd/mm/yyyy'),to_date('23/09/2012','dd/mm/yyyy'),
   15, 32430, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   105, 209, to_date('04/09/2012', 'dd/mm/yyyy'),to_date('18/09/2012','dd/mm/yyyy'),
   11, 2722.24, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   106, 210, to_date('07/09/2012', 'dd/mm/yyyy'),to_date('15/09/2012','dd/mm/yyyy'),
   12, 15634, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   107, 211, to_date('07/09/2012', 'dd/mm/yyyy'),to_date('21/09/2012','dd/mm/yyyy'),
   15, 142171, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   108, 212, to_date('07/09/2012', 'dd/mm/yyyy'),to_date('10/09/2012','dd/mm/yyyy'),
   13, 149570, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   109, 213, to_date('08/09/2012', 'dd/mm/yyyy'),to_date('28/09/2012','dd/mm/yyyy'),
   11, 1020935, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   110, 214, to_date('09/09/2012', 'dd/mm/yyyy'),to_date('21/09/2012','dd/mm/yyyy'),
   11, 1539.13, 'CASH', 'Y');
INSERT INTO s_ord VALUES (
   111, 204, to_date('09/09/2012', 'dd/mm/yyyy'),to_date('21/09/2012','dd/mm/yyyy'),
   11, 2770, 'CASH', 'Y');
INSERT INTO s_ord VALUES (
   97, 201,  to_date('02/08/2012', 'dd/mm/yyyy'),to_date('17/09/2012','dd/mm/yyyy'),
   12, 84000, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   98, 202,  to_date('31/08/2012', 'dd/mm/yyyy'),to_date('10/09/2012','dd/mm/yyyy'),
   14, 595, 'CASH', 'Y');
INSERT INTO s_ord VALUES (
   99, 203,  to_date('31/08/2012', 'dd/mm/yyyy'),to_date('18/09/2012','dd/mm/yyyy'),
   14, 7707, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   112, 210,  to_date('31/08/2012','dd/mm/yyyy'),to_date('10/09/2012','dd/mm/yyyy'),
   12, 550, 'CREDIT', 'Y');
COMMIT;
